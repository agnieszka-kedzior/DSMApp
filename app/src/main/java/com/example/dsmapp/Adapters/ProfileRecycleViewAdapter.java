...
public class ProfileRecycleViewAdapter extends RecyclerView.Adapter<ProfileRecycleViewAdapter.ViewHolder>{
    ...
    public ProfileRecycleViewAdapter(Context ctx, OnProfileClickListener onProfileClickListener , List<String> mUserIdList, List<String> mUserNameList) {
        this.ctx = ctx;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.profile_friends_recycle_layout, viewGroup, false);
