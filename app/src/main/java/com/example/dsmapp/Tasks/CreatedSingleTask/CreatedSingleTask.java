...
public class CreatedSingleTask extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.created_task, container,false);
    ...
    public static CreatedSingleTask newInstance(String mToken, String mTaskId){
        CreatedSingleTask fragmentTasks = new CreatedSingleTask();
    ...
    public void setFrag(){
        Fragment frag = null;
        frag = FragAction.newInstance(mToken,mTaskId);
